<template>
    <div class="z-50 bottom h-full w-full">
        <div class="py-2 w-full">
            <div class="flex items-center justyfy-between">
                <div class="flex itmes-center text-white">
                ...
                >
                    <button 
                        :disabled="isDeleting"
                        class="flex items-center text-white p-1 h-[24px] w-[24px] hower:bg-gray-800 rounded-full cursor-pointer"
